...
namespace baodeag
{
    public class AITormentedSoulBossCharacterManager : AIBossCharacterManager
    {
        [HideInInspector] public AITormentedSoulCombatManager tormentedSoulCombatManager;
        [HideInInspector] public DeathMoonSlash deathMoonSlash;
