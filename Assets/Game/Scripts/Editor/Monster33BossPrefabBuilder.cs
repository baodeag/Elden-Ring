...
namespace baodeag.EditorTools
{
    ...
    {
        private const string SourceTemplatePath = GameAssetPaths.PrefabsRoot + "/Character/Undead/Undead_Dummy_33.prefab";
        private const string BossReferencePath = GameAssetPaths.PrefabsRoot + "/Character/Boss/Durk_Boss_01.prefab";
        private const string MonsterVisualPath = GameAssetPaths.Stylized3DMonsterRoot + "/Monster33_FreeTrial/Prefab/Monster33_01.prefab";
        private const string MonsterModelPath = GameAssetPaths.Stylized3DMonsterRoot + "/Monster33_FreeTrial/Monster33_FreeTrial.fbx";
        private const string MonsterPrimaryMaterialPath = GameAssetPaths.Stylized3DMonsterRoot + "/Monster33_FreeTrial/ShaderTexture/Texture/Materials/Monster33_Color06.mat";
        private const string MonsterBurningBodyVFXPath = GameAssetPaths.PrefabsRoot + "/Visual FX/VFX_Burning_01.prefab";
        private const string MonsterFireWeaponTrailPath = GameAssetPaths.AddonsRoot + "/JMO Assets/Cartoon FX Remaster/CFXR Prefabs/Sword Trails/Fire/CFXR4 Sword Trail FIRE (360 Thin Spiral).prefab";
        private const string MonsterFireWeaponMaterialPath = GameAssetPaths.MaterialsRoot + "/Monster33_Weapon_Fire_Orange.mat";
        private const string MonsterFireHitVFXPath = GameAssetPaths.AddonsRoot + "/JMO Assets/Cartoon FX Remaster/CFXR Prefabs/Sword Trails/Fire/CFXR4 Sword Hit FIRE (Cross).prefab";
        private const string DurkAnimatorControllerPath = GameAssetPaths.DataRoot + "/Animator Controllers/Durk.controller";
        private const string MonsterIdleAnimationPath = GameAssetPaths.Stylized3DMonsterRoot + "/Monster33_FreeTrial/Anim/Monster33_Idle.anim";
        private const string MonsterWalkAnimationPath = GameAssetPaths.Stylized3DMonsterRoot + "/Monster33_FreeTrial/Anim/Monster33_Walk_InPlace.anim";
        private const string MonsterRebasedIdleAnimationPath = GameAssetPaths.Stylized3DMonsterRoot + "/Monster33_FreeTrial/Anim/Monster33_Boss_Idle_Rebased.anim";
        private const string MonsterRebasedWalkAnimationPath = GameAssetPaths.Stylized3DMonsterRoot + "/Monster33_FreeTrial/Anim/Monster33_Boss_Walk_Rebased.anim";
        private const string TargetAnimatorControllerPath = GameAssetPaths.DataRoot + "/Animator Controllers/Monster33_Boss_Clean.controller";
        private const string LegacyAnimatorControllerPath = GameAssetPaths.DataRoot + "/Animator Controllers/Monster33_Boss.controller";
        ...
        private const string TargetAttackStatePath = GameAssetPaths.DataRoot + "/AI States/Monster33/Monster33 Attack State.asset";
        private const string TargetCombatStanceStatePath = GameAssetPaths.DataRoot + "/AI States/Monster33/Monster33 Combat Stance State.asset";
        private const string TargetPhase02CombatStanceStatePath = GameAssetPaths.DataRoot + "/AI States/Monster33/Monster33 Combat Stance State Phase02.asset";
        ...
        private const string TargetAttack01Path = GameAssetPaths.DataRoot + "/AI Attack Actions/Monster33/Monster33 Attack 01.asset";
        private const string TargetAttack01ComboPath = GameAssetPaths.DataRoot + "/AI Attack Actions/Monster33/Monster33 Attack 01 Combo.asset";
        private const string TargetAttack02Path = GameAssetPaths.DataRoot + "/AI Attack Actions/Monster33/Monster33 Attack 02 Charged.asset";
        private const string TargetAttack03Path = GameAssetPaths.DataRoot + "/AI Attack Actions/Monster33/Monster33 Attack 03 Charged.asset";
        private const string HellFireKnightAttackPath = GameAssetPaths.ArtRoot + "/Animations/Humanoid/Hell Fire Knight/Sword And Shield Attack.fbx";
        private const string HellFireKnightAttackRebasedPath = GameAssetPaths.ArtRoot + "/Animations/Humanoid/Hell Fire Knight/Monster33_Sword And Shield Attack.anim";
        private const string HellFireKnightSlashPath = GameAssetPaths.ArtRoot + "/Animations/Humanoid/Hell Fire Knight/Sword And Shield Slash.fbx";
        private const string HellFireKnightSlashRebasedPath = GameAssetPaths.ArtRoot + "/Animations/Humanoid/Hell Fire Knight/Monster33_Sword And Shield Slash.anim";
        private const string HellFireKnightSlashAltPath = GameAssetPaths.ArtRoot + "/Animations/Humanoid/Hell Fire Knight/Sword And Shield Slash (1).fbx";
        private const string HellFireKnightSlashAltRebasedPath = GameAssetPaths.ArtRoot + "/Animations/Humanoid/Hell Fire Knight/Monster33_Sword And Shield Slash (1).anim";
        private const string HellFireKnightComboPath = GameAssetPaths.ArtRoot + "/Animations/Humanoid/Hell Fire Knight/Sword And Shield Slash (1).fbx";
        private const string HellFireKnightComboRebasedPath = GameAssetPaths.ArtRoot + "/Animations/Humanoid/Hell Fire Knight/Monster33_Sword And Shield Combo.anim";
        private const string HellFireKnightPowerUpPath = GameAssetPaths.ArtRoot + "/Animations/Humanoid/Hell Fire Knight/Sword And Shield Power Up.fbx";
        private const string HellFireKnightPowerUpRebasedPath = GameAssetPaths.ArtRoot + "/Animations/Humanoid/Hell Fire Knight/Monster33_Sword And Shield Power Up.anim";
        private const string TargetPrefabPath = GameAssetPaths.PrefabsRoot + "/Character/Boss/Monster33_Boss_01.prefab";
